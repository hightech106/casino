/**
 * Main application entry point for the LuckVerse777 backend server.
 * Initializes Express app, configures middleware, sets up API routes (v1/v2/v3), Socket.IO connections,
 * and MongoDB connection. Handles cluster mode for production scaling.
 */
"use strict";
...
if (cluster.isPrimary && process.env.CLUSTER) {
    ...
    // Casino redirect for backward compatibility (luckverse777.com/casino/ -> /api/v3/games/timelesstech/)
    ...
    mongoose
        ...
        .then(() => {
            ...
            console.log('[Socket.IO] ✅ Socket.IO server initialized with CORS: *');
