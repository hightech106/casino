/**
 * Database initialization script that sets up default admin user, role, and currency.
 * Creates initial admin account with default credentials and USDT currency configuration.
 * Should be run once during initial setup - idempotent (uses upsert operations).
 */
"use strict";
