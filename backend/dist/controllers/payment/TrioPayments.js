"use strict";
/**
 * Module providing TrioPayments functionality.
 */
/**
 * TrioPayments gateway integration. Handles alternative payment processing.
 */
    ...
    try {
        const response = yield axios_1.default.post(API_LINK_TRIO, {
            transaction: {
                ...
                amount: amount,
                external_id: ext_id,
                description: 'Paid to luckverse777.com',
                redirect_url: 'https://luckverse777.com/en/user/wallet',
            },
            receiver: {
