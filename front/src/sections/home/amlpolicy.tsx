...
import AMLPOLICY_LANG from 'src/locales/langs/global/amlpolicy';
                    ...
                    <Scrollbar>
                        ...
                        >
                            <Stack gap={1} alignItems="center" mb={3}>
                                <Typography variant='h4' >{t("aml_policy")}</Typography>
                            </Stack>

                            {(AMLPOLICY_LANG[currentLang.value] || []).map((row, index) => (
                                <Stack key={index}>
                                    <Button
