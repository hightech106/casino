...
// types
import type { IChatParticipant, IChatConversations } from '../chat.type';
//
...
export default function ChatNav({
  ...
  const handleClickCompose = useCallback(() => {
    ...
    router.push(paths.user.support);
  ...
  const handleClickResult = useCallback(
    (result: IChatParticipant) => {
      ...
      router.push(`/${currentLang.value}${paths.user.support}?id=${result.id}`);
    },
    [handleClickAwaySearch, router, currentLang]
  );
