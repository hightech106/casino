"use strict";
/**
 * Module providing custom functionality.
 */
/**
 * Custom journey flow controller. Handles user-defined journey workflows.
 */
...
const sendJourneyEmail = async (toPlayers, node) => {
    ...
    try {
        console.log('custom.js:56: Sending mailOptions:', mailOptions);
