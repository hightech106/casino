/**
 * User activity calculation controller that processes game and balance history data.
 * Calculates user activity metrics, updates affiliate rewards, and manages user segmentation based on gameplay patterns.
 * Runs periodically via cron jobs to maintain accurate activity tracking for bonuses and rewards.
 */
"use strict";
            ...
            yield Promise.all(chunk.map((stat) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                if (stat.turnover > 0 || stat.bonuses > 0) {
                    try {
                        ...
                        // To do *** temporary disable error logging
