...
const FAQ_LANG: IFAQ_LANG = {
    "en": [
        ...
        },
        {
            ...
            answer: (
                <Typography>
                    At LuckVerse777, we maintain fair play to the highest standards and deliver only the best games from leading and verified providers.< br /> Last but not least, all games have the necessary certificates - for random number generators and for RTP.
                </Typography>
            )
        },
        {
        ...
        {
            question: "Is all my information secure on LuckVerse777?",
            answer: (
                <Typography>
    ...
    "ru": [
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    В LuckVerse777 мы поддерживаем честную игру на самом высоком уровне и предлагаем только лучшие игры от ведущих и проверенных провайдеров.<br /> В заключение, все игры имеют необходимые сертификаты - для генераторов случайных чисел и для RTP.
                </Typography>
            )
        },
        {
        ...
        {
            "question": "Безопасна ли вся моя информация на LuckVerse777?",
            "answer": (
                <Typography>
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    Конечно. Вы можете выбрать период охлаждения или самоисключиться на срок до одного года в своем личном профиле.<br /> Вы также можете попросить нашу службу поддержки закрыть ваш аккаунт с возможностью его повторного открытия позже.<br /> Просто свяжитесь с ними напрямую через LiveChat или отправьте электронное письмо на <Link> support@luckverse777.com </Link>. Они решат все как можно быстрее.
                </Typography>
            )
        }
    ],
    "nb": [
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    Hos LuckVerse777 opprettholder vi rettferdig spill på høyeste standard og leverer kun de beste spillene fra ledende og verifiserte leverandører.<br /> Sist, men ikke minst, har alle spillene de nødvendige sertifikatene - for tilfeldige tallgeneratorer og for RTP.
                </Typography>
            )
        },
        {
        ...
        {
            "question": "Er all informasjonen min sikker på LuckVerse777?",
            "answer": (
                <Typography>
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    Selvfølgelig. Du kan velge en avkjølingsperiode eller selvutestenge deg i opptil ett år i din personlige profil.<br /> Du kan også be vårt supportteam om å stenge kontoen din med mulighet for å åpne den igjen senere.<br /> Bare kontakt dem direkte gjennom LiveChat eller send en e-post til <Link>support@luckverse777.com</Link> De vil ordne alt så raskt som mulig.
                </Typography>
            )
        }
    ],
    "fi": [
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    LuckVerse777:llä ylläpidämme reilua peliä korkeimmilla standardeilla ja tarjoamme vain parhaita pelejä johtavilta ja varmennetuista tarjoajilta.<br /> Kaikilla peleillä on tarvittavat sertifikaatit - satunnaislukugeneraattoreille ja RTP:lle.
                </Typography>
            )
        },
        {
        ...
        {
            "question": "Onko kaikki tietoni turvallisia LuckVerse777:llä?",
            "answer": (
                <Typography>
    ...
    "sv": [
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    På LuckVerse777 upprätthåller vi rättvist spelande enligt de högsta standarderna och erbjuder endast de bästa spelen från ledande och verifierade leverantörer.<br /> Sist men inte minst har alla spel de nödvändiga certifikaten - för slumptalsgeneratorer och för RTP.
                </Typography>
            )
        },
        {
        ...
        {
            "question": "Är all min information säker på LuckVerse777?",
            "answer": (
                <Typography>
    ...
    "es": [
        {
            ...
            "answer": (
                <Typography>
                    Si olvidaste tu contraseña, puedes obtener una nueva inmediatamente utilizando la página de olvido de contraseña.< br /> Si tienes algún problema, nuestro personal de soporte súper amigable te ayudará de 8:00 a.m. a 12:00 p.m. en tiempo real a través del chat - el icono naranja en la parte inferior derecha de esta página abrirá el chat - o por correo electrónico a <Link>support@luckverse777.com</Link>.
                </Typography>
            )
        },
        {
            ...
            "answer": (
                <Typography>
                    En LuckVerse777, mantenemos el juego justo con los más altos estándares y ofrecemos solo los mejores juegos de proveedores líderes y verificados.< br /> Por último, pero no menos importante, todos los juegos tienen los certificados necesarios - para generadores de números aleatorios y para RTP.
                </Typography>
            )
        },
        {
        ...
        {
            "question": "¿Está toda mi información segura en LuckVerse777?",
            "answer": (
                <Typography>
    ...
    "de": [
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    Bei LuckVerse777 gewährleisten wir faire Spiele auf höchstem Niveau und bieten nur die besten Spiele von führenden und verifizierten Anbietern an.<br /> Nicht zuletzt haben alle Spiele die notwendigen Zertifikate - sowohl für Zufallszahlengeneratoren als auch für RTP.
                </Typography>
            )
        },
        {
        ...
        {
            "question": "Sind meine Informationen auf LuckVerse777 sicher?",
            "answer": (
                <Typography>
    ...
    "fr": [
        ...
        },
        {
            ...
            "answer": (
                <Typography>
                    Chez LuckVerse777, nous maintenons l&apos;équité des jeux selon les normes les plus strictes et proposons uniquement les meilleurs jeux des fournisseurs vérifiés et leaders.< br /> Enfin, tous les jeux possèdent les certificats nécessaires - pour les générateurs de nombres aléatoires et pour le RTP.
                </Typography>
            )
        },
        {
        ...
        {
            "question": "Toutes mes informations sont-elles sécurisées sur LuckVerse777 ?",
            "answer": (
                <Typography>
