...
import { ICard, IMULTIPLIER, IRank, ISuit } from "./types"
...
export const MULTIPLIERS: IMULTIPLIER = {
    'A': {
        'Lower': 12.870,
        'Higher': 1.073
    },
...
export function generateRandomCard(): ICard {
...
export function getCardRankValue(card: ICard): number {
