/**
 * Ethereum blockchain payment integration controller.
 * Handles ETH/ERC20 token deposits and withdrawals using Web3 and Ethereum transactions.
 * Manages blockchain transaction creation, signing, and confirmation for Ethereum-based payments.
 */
"use strict";
...
const transferErc20 = (senders, reciever, contractInfo, amount) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (Number((0, units_1.formatUnits)(balance, decimals)) < Number(amount)) {
            ...
            const etherFee = Number(transactionFeeAmount) * 1.5;
            const erc20Amount = Number(amount) - etherFee;
            if (erc20Amount < 0)
