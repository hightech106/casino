 ...
 */
/**
 * Marketing email controller. Handles marketing email campaigns and distribution.
 */
    ...
    try {
        ...
        if (result.status && time_send.length && time_send.includes(today)) {
            ...
            if (event === 'email' && toPlayers.length) {
                ...
                console.log('marketing/email.js:123: create mailOptions:', mailOptions);
