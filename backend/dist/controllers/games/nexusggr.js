"use strict";
/**
 * Module providing nexusggr functionality.
 */
/**
 * Nexus GGR game provider integration. Manages Nexus game provider operations.
 */
    ...
    try {
        ...
        providers.forEach((provider) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (result.data.msg === "SUCCESS" && result.data.status === 1 && result.data.games.length) {
                const query = result.data.games.map((list) => (Object.assign(Object.assign({}, list), { provider_code: provider.code, banner: list.banner.replaceAll("https://assets.fiverscool.com", "https://luckverse777.com/banners") })));
