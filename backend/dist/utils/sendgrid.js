"use strict";
/**
 * Module providing sendgrid functionality.
 */
...
const sendMail = ({ to, from, subject, templateId = '', html = '', dynamicTemplateData = null }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const errorDetails = ((_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.body) || err;
        console.error('Failed sending email error:', JSON.stringify(errorDetails, null, 2));
        console.error('SendGrid error message:', err?.response?.body?.errors?.[0]?.message || err?.message);
        // Return false for backward compatibility, but log detailed error
        return false;
    }
});
