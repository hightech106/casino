...
import SUPPORTED_CRYPTO_LANG from 'src/locales/langs/global/supportcrypto';
                    ...
                    <Scrollbar>
                        ...
                        >
                            <Stack gap={1} alignItems="center" mb={3}>
                                <Typography variant='h4' >{t("supported_crypto")}</Typography>
                                <Typography variant='body1' textAlign="center">
                                    {t("supported_crypto_desc", { label: APP_NAME })}
                                </Typography>
                            </Stack>

                            {(SUPPORTED_CRYPTO_LANG[currentLang.value] || []).map((row, index) => (
                                <Stack key={index}>
                                    <Button
