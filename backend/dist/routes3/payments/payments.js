...
// Specific routes with :id must come before general routes like /approve
router.post('/:id/approve', auth_1.AGVerifytoken, validation_1.V.params(validation_1.Validator.ObjectId), payments_1.approvePaymentById);
router.post('/:id/reject', auth_1.AGVerifytoken, validation_1.V.params(validation_1.Validator.ObjectId), payments_1.rejectPaymentById);
