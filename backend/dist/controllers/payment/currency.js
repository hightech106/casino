 ...
 */
/**
 * Currency management controller. Manages supported currencies and exchange rates.
 */
...
const get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield models_1.Currencies.find().sort({ status: -1, order: 1, createdAt: -1 });
    res.json(result);
});
exports.get = get;
