...
import GAMBLING_LANG from 'src/locales/langs/global/gambling';
...
export default function GamblingView() {
                    ...
                    <Scrollbar>
                        ...
                        >
                            <Stack gap={1} alignItems="center" mb={3}>
                                <Typography variant='h4' >{t("responsible_gambling")}</Typography>
                            </Stack>

                            {(GAMBLING_LANG[currentLang.value] || []).map((row, index) => (
                                <Stack key={index}>
                                    <Button
