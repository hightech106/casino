/**
 * Material-UI theme provider that merges base theme with user settings (mode, presets, contrast, direction).
 * Dynamically creates theme based on settings context and applies component overrides and RTL support.
 * Note: Theme is memoized for performance, and all theme options are merged using lodash merge.
 */
