  ...
  theme: {
    extend: {
      boxShadow: {
        ...
        custom2: '0 0 6px 1px  rgba(7, 16, 23, 0.3)'
      },
      colors: {
        panel: "#0f212e",
        inputborader: "#2f4553",
      ...
      keyframes: {
        ...
        growAni: {
          from: { transform: "translate(0px, 20px) scale(0.5)" },
      ...
      animation: {
        ...
        growAni: "growAni 0.7s ease-out forwards",
        bloomAni: "bloomAni 1.3s ease-in-out forwards 0.2s",
        diedAni: "diedAni 0.3s ease-in forwards",
        downAni: "downAni 0.3s ease-in forwards",
