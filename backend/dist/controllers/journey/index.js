/**
 * User journey flow management controller for marketing automation.
 * Handles journey flow creation, updates, triggering (email/SMS/login notifications), and flow cloning.
 * Manages multi-step user journeys based on events and conditions for engagement campaigns.
 */
"use strict";
...
const triggerEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log('index.js:245: triggerEmail mailOptions:', mailOptions);
