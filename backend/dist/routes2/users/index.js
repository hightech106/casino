"use strict";
/**
 * Index file exporting users modules and routes.
 */
...
router.post('/send-withdrawal-verification', loginLimiter, validation_1.V.body(validation_1.Validator.Users.Auth.SendWithdrawalVerification), auth_1.verifyToken, users_1.send_withdrawal_verification_code);
