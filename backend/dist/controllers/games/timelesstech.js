"use strict";
/**
 * Module providing timelesstech functionality.
 */
/**
 * TimelessTech game provider integration. Handles game launches and transactions for TimelessTech games.
 */
...
const changebalance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!luCurrency) {
            console.error('LU currency not found!');
            return res.json(errorRes(req.body, 'OP_30', 'System configuration error'));
        }
...
const balance = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(`[BALANCE REQUEST] User: ${user._id}, Currency: LU`);
